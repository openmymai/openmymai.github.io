...
const Lesson0207 = () => {
  ...
  useEffect(() => {
    const options = {
      strings: [
          `โลกและองค์ประกอบของโลกคือดิน น้ำ ลม ไฟ`,
          `ทั้งหมดเป็นธรรมชาติชนิดหนึ่ง`,
          `เกิดจากเหตุปัจจัยมาประชุมปรุงแต่งชั่วคราว แล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเองไม่เที่ยงเกิดดับ ดับไม่เหลือ`,
          ...
          `เป็นเหตุเป็นปัจจัยมาประชุมปรุงแต่งชั่วคราว แล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเอง`,
          `ไม่ควรไปยึดมั่นถือมั่นว่าสิ่งนั้นเป็นของเรา เป็นเรา เป็นตัวตนของเรา`,
          `ไม่เที่ยงเกิดดับ ดับไม่เหลือ`,
 
          `ชีวิตและองค์ประกอบของโลกคือดิน น้ำ ลม ไฟ กรรมและวิญญาณ`,
          `ทั้งหมดเป็นธรรมชาติชนิดหนึ่ง`,
          `เกิดจากเหตุปัจจัยมาประชุมปรุงแต่งชั่วคราว แล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเองไม่เที่ยงเกิดดับ ดับไม่เหลือ`,
          ...
          `ไต ปอด ไส้ใหญ่ ไส้น้อย อาหารเก่า อาหารใหม่`,
          `หรือแม้สิ่งอื่นไม่ว่าชนิดไรๆที่แข้นแข็ง`,
          `กำหนดได้มีในตนอาศัยตน`,
          ...
          `ทั้งหมดเป็นธรรมชาติชนิดหนึ่ง`,
          `กิดจากเหตุปัจจัยมาประชุมกันชั่วคราวแล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเอง`,
          `ไม่ควรเห็นสิ่งนั้นว่าเป็นของเรา เป็นเรา เป็นตัวตนของเรา`,
          `ครั้นเห็นแล้วจะเบื่อหน่ายปฐวีธาตุ`,
          `และให้จิตคลายกำหนัดไม่ยึดมั่นถือมั่นปฐวีธาตุได้ไม่เที่ยงเกิดดับ`,
          ...
          `หรือแม้แต่สิ่งอื่นไม่ว่าชนิดไรๆที่เอิบอาบซึมซาบไป`,
          `กำหนดได้มีในตนอาศัยตน`,
          ...
          `และให้จิตคลายกำหนัดไม่ยึดมั่นถือมั่นอาโปธาตุได้ไม่เที่ยงเกิดดับ`,
          ...
          `เกิดจากเหตุปัจจัยมาประชุมกันชั่วคราวแล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเอง`,
          `ไม่ควรเห็นสิ่งนั้นว่าเป็นของเรา ป็นเรา เป็นตัวตนของเรา`,
          `ครั้นเห็นแล้วจะเบื่อหน่ายวาโยธาตุ`,
          `และให้จิตคลายกำหนัดไม่ยึดมั่นถือมั่นวาโยธาตุได้ไม่เที่ยงเกิดดับ`,
          ...
          `และธาตุที่เป็นเหตุให้ของกิน ที่กิน ที่ดื่ม ที่เคี้ยว`,
          `ที่ลิ้มแล้วถึงความย่อยไปด้วยดี`,
          `หรือแม้แต่สิ่งอื่นไม่ว่าชนิดไรๆที่อบอุ่นถึงความเร่าร้อน`,
          `กำหนดได้มีในตนอาศัยตน`,
          ...
          `และให้จิตคลายกำหนัดไม่ยึดมั่นถือมั่นเตโชธาตุได้ไม่เที่ยงเกิดดับ`,
          `อากาศธาตุ (ความว่าง)`,
          `ก็อากาศธาตุเป็นไฉน`,
          ...
          `ซึ่งเป็นทางให้กลืนของกิน ที่ดื่ม ที่เคี้ยว ที่ลิ้ม`,
          `และเป็นทางระบายของที่กิน ที่เคี้ยว ที่ดื่ม`,
          `แล้วออกมาทางเบื้องล่าง`,
          `หรือแม้แต่สิ่งอื่นไม่ว่าชนิดไรๆที่ว่างปรุโปร่ง`,
          `กำหนดได้มีในตนอาศัยตน`,
          `นี้เรียกว่าอากาศธาตุภายใน`,
          `ก็อากาศธาตุทั้งภายในและภายนอกนี้แล`,
          `เป็นอากาศธาตุทั้งนั้น`,
          `พึงเห็นอากาศธาตุนั้นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนี้ว่า`,
          `ทั้งหมดเป็นธรรมชาติชนิดหนึ่ง`,
          `เกิดจากเหตุปัจจัยมาประชุมกันชั่วคราวแล้วแตกสลาย`,
          `ไม่มีตัวตนเป็นของตนเอง`,
          `ไม่ควรเห็นสิ่งนั้นว่าเป็นของเรา เป็นเรา เป็นตัวตนของเรา`,
          `ครั้นเห็นแล้วจะเบื่อหน่ายอากาศธาตุ`,
          `และให้จิตคลายกำหนัดไม่ยึดมั่นถือมั่นอากาศธาตุได้ไม่เที่ยงเกิดดับ`,
          
          `วิญญาณธาตุ (ความรู้)`,
          `ต่อจากนั้นสิ่งที่เหลืออยู่ก็คือวิญญาณธาตุอันบริสุทธิ์ผุดผ่อง`,
          ...
          `ย่อมรู้สึกว่าความเสวยอารมณ์ที่เกิดแก่ผัสสะนั้นคือตัวสุขเวทนา`,
          `อันเกิดเพราะอาศัยผัสสะเป็นที่ตั้งแห่งสุขเวทนาย่อมดับไปย่อมเข้าไปสงบ`,
          ...
          `คือตัวทุกขเวทนา`,
          `อันเกิดเพราะอาศัยผัสสะเป็นที่ตั้งแห่งทุกขเวทนาย่อมดับไป`,
          `ย่อมเข้าไปสงบ`,
          `เพราะอาศัยผัสสะเป็นที่ตั้งแห่งไม่ทุกข์ ไม่สุขเวทนา`,
          `ย่อมเกิดไม่ทุกข์ ไม่สุขเวทนา`,
          `บุคคลนั้นเมื่อเสวยไม่ทุกข์​ ไม่สุขเวทนา`,
          `ย่อมรู้สึกว่ากำลังเสวยไม่ทุกข์ ไม่สุขเวทนาอยู่`,
          `เพราะผัสสะเป็นที่ตั้งแห่งไม่ทุกข์ ไม่สุขเวทนานั้นแลดับไป`,
          `ย่อมรู้สึกว่าความเสวยอารมณ์ที่เกิดแก่ผัสสะนั้น`,
          `คือตัวไม่ทุกข์ ไม่สุขเวทนา`,
          `อันเกิดเพราะอาศัยผัสสะเป็นที่ตั้งแห่งไม่ทุกข์ ไม่สุขเวทนาย่อมดับไป`,
          `ย่อมเข้าไปสงบ`,
