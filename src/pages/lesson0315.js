  ...
  useEffect(() => {
    const options = {
      strings: [
        ...
        `ปฐวีธาตุที่เป็นภายในก็ดีเป็นภายนอกก็ดี`,
        `ปฐวีธาตุนั้นก็เป็นแต่สักว่าปฐวีธาตุเท่านั้น`,
        `พึงเห็นปฐวีธาตุนั้นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนี้ว่า`,
        `นั่นไม่ใช่ของเรา นั่นไม่เป็นเรา นั่นไม่ใช่ตัวตนของเรา`,
        `เพราะเห็นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนั้น`,
        `จิตย่อมเบื่อหน่ายในปฐวีธาตุ`,
        `ย่อมคลายกำหนัดในปฐวีธาตุ`,

        `อาโปธาตุที่เป็นภายในก็ดีเป็นภายนอกก็ดี`,
        `อาโปธาตุนั้นก็เป็นแต่สักว่าอาโปธาตุเท่านั้น`,
        `พึงเห็นอาโปธาตุนั้นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนี้ว่า`,
        `นั่นไม่ใช่ของเรานั่นไม่เป็นเรานั่นไม่ใช่ตัวตนของเรา`,
        `เพราะเห็นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนั้น`,
        `จิตย่อมเบื่อหน่ายในอาโปธาตุ`,
        `ย่อมคลายกำหนัดในอาโปธาตุ`,

        `เตโชธาตุที่เป็นภายในก็ดีเป็นภายนอกก็ดี`,
        `เตโชธาตุนั้นก็เป็นแต่สักว่าเตโชธาตุเท่านั้น`,
        `พึงเห็นเตโชธาตุนั้นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนี้ว่า`,
        `นั่นไม่ใช่ของเรานั่นไม่เป็นเรานั่นไม่ใช่ตัวตนของเรา`,
        `เพราะเห็นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนั้น`,
        `จิตย่อมเบื่อหน่ายในเตโชธาตุย่อมคลายกำหนัดในเตโชธาตุ`,

        `วาโยธาตุที่เป็นภายในก็ดีเป็นภายนอกก็ดี`,
        `วาโยธาตุนั้นก็เป็นแต่สักว่าวาโยธาตุเท่านั้น`,
        `พึงเห็นวาโยธาตุนั้นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนี้ว่า`,
        `นั่นไม่ใช่ของเรานั่นไม่เป็นเรานั่นไม่ใช่ตัวตนของเรา`,
        `เพราะเห็นด้วยปัญญาอันชอบตามความเป็นจริงอย่างนั้น`,
        `จิตย่อมเบื่อหน่ายในวาโยธาตุย่อมคลายกำหนัดในวาโยธาตุ`,
    ...
    <>
      ...
      <section id="home" className="flex section--dark">
          ...
          <div className="next">
            ...
            <a className="space" href="/lesson0316" >
